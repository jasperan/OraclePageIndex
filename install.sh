...
# ============================================================
# OraclePageIndex — One-Command Installer
...
REPO_URL="https://github.com/jasperan/OraclePageIndex.git"
PROJECT="OraclePageIndex"
BRANCH="main"
...
print_banner() {
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BOLD}  OraclePageIndex${NC}"
    echo -e "  OraclePageIndex: Graph-Powered Document Intelligence"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
...
check_prereqs() {
    ...
    [ -n "$PYTHON" ] || fail "Python 3.11+ is required — https://www.python.org/downloads/"
...
print_done() {
    ...
    echo -e "  ${BOLD}Commands:${NC}  oracle-pageindex"
    echo ""
